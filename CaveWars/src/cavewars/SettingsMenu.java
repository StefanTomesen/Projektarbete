...
class SettingsMenu extends Menu {
    ...
    public SettingsMenu() {
        MenuButton resol1 = new MenuButton("resol1", "500 x 250", width/4, height/6);
    ...
    public void buttonPressed(String id) {
        switch(id){
            case("resol1"): y = 0; break;
            case("resol2"): y = 1; break;
            case("resol3"): y = 2; break;
            case("resol4"): y = 3; break;
            case("resol5"): y = 4; break;
